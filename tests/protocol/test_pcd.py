...
from custom_components.dreame_a2_mower.protocol.pcd import PCDHeaderError, decode_pcd_header, decode_pcd
...
def test_decode_pcd_cloud_carries_point_stride_and_bytes_per_point():
